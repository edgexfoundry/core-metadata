...
public class ScheduleDaoTest {
	...
	public void createTestData() {
		...
		DeviceReport r = ReportData.newTestInstance();
		rptRepos.save(r);
	...
	public void testGetByIdOrName() {
		Schedule s = ScheduleData.newTestInstance();
		s.setName(TEST_SCHEDULE_NAME);
		assertNotNull("Schedule is null on getByIdOrName with valid name", dao.getByIdOrName(s));
		s.setName(null);
		s.setId(id);
		assertNotNull("Schedule is null on getByIdOrName with valid id", dao.getByIdOrName(s));
	}
	...
	public void testGetByIdOrNameWithBadIdentifiers() {
		Schedule s = ScheduleData.newTestInstance();
		s.setId("badid");
		assertNull("No schedule should be found with bad id on getByIdOrName", dao.getByIdOrName(s));
		s.setId(null);
		s.setName("badname");
		assertNull("No schedule should be found with bad name on getByIdOrName", dao.getByIdOrName(s));
	}
	...
	public void testGetAffectedServices() {
		...
		assertEquals("Affected servcies does not include appropriate service", ServiceData.TEST_SERVICE_NAME,
	...
	public void testGetAffectedServicesWithNone() {
		...
		s.setName(TEST_SCHEDULE_NAME_NONE);
		s.setId(null);
		assertTrue("Affected services should be empty - none assocaited",
				dao.getAffectedServices(s).isEmpty());
	}

	@Test
	public void testGetAffectedServicesGivenNull() {
		assertTrue("Affected services should be empty - none assocaited", dao.getAffectedServices(null).isEmpty());
	}
}
