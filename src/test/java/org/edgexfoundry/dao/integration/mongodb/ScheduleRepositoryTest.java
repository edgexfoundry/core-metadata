...
public class ScheduleRepositoryTest {
	...
	public void testFindAll() {
		List<Schedule> as = repos.findAll();
	...
	public void testUpdate() {
		...
		assertEquals("Modified and created timestamps should be equal after creation", schedule.getModified(),
				schedule.getCreated());
		...
		assertNotEquals("after modification, modified timestamp still the same as the schedule's create timestamp",
				sch2.getModified(), sch2.getCreated());
	}

	@Test
	public void testDelete() {
		Schedule p = repos.findOne(id);
		repos.delete(p);
