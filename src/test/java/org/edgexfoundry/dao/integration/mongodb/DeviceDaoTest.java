...
public class DeviceDaoTest {
	...
	public void testGetByIdOrName() {
		Device d = new Device();
		d.setId(id);
		assertNotNull("Device is null on getByIdOrName with valid id", dao.getByIdOrName(d));
		d.setName(TEST_NAME);
		d.setId(null);
		assertNotNull("Device is null on getByIdOrName with valid name", dao.getByIdOrName(d));
	}
	...
	public void testGetByIdOrNameWithBadIdentifiers() {
		Device d = new Device();
		d.setId("badid");
		assertNull("No device should be found with bad id on getByIdOrName", dao.getByIdOrName(d));
		d.setName("badname");
		d.setId(null);
		assertNull("No device should be found with bad id on getByIdOrName", dao.getByIdOrName(d));
	}
