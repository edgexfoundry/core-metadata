...
public class ScheduleEventDaoTest {
	...
	public void testGetByIdOrName() {
		ScheduleEvent e = ScheduleEventData.newTestInstance();
		assertNotNull("Schedule event is null on getByIdOrName with valid name", dao.getByIdOrName(e));
		e.setName(null);
		e.setId(id);
		assertNotNull("Schedule event is null on getByIdOrName with valid id", dao.getByIdOrName(e));
	}

	@Test
	public void testGetByIdOrNameWithNull() {
		assertNull("No schedule event should be found with null on getByIdOrName", dao.getByIdOrName(null));
	}
	...
	public void testGetByIdOrNameWithBadIdentifiers() {
		ScheduleEvent e = ScheduleEventData.newTestInstance();
		e.setId("badid");
		assertNull("No schedule event should be found with bad id on getByIdOrName", dao.getByIdOrName(e));
		e.setId(null);
		e.setName("badname");
		assertNull("No schedule event should be found with bad name on getByIdOrName", dao.getByIdOrName(e));
	}
	...
	public void testGetAffectedServicesGivenNull() {
		assertTrue("Affected services should be empty - none asocaited", dao.getAffectedService(null).isEmpty());
	}
}
